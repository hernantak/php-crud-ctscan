$(document).ready(function(){
	...
	$("#btn-simpan").click(function(){ // Ketika tombol simpan di klik
		...
		// data.append('dataset_id', $("#dataset_id").val()); // Ambil data nis
		data.append('dataset_name', $("#dataset_name").val()); // Ambil data nama
		data.append('medic_record', $("#medic_record").val()); // Ambil data jenis kelamin
		// data.append('status', $("#status").val()); // Ambil data telepon
		...
		$.ajax({
			url: 'proses_upload.php', // File tujuan
